...
const cardContainer = document.getElementById("cardscont");
    ...
    //     card.map(card=>{
    //             const name = document.querySelectorAll('displayName');
    //             const email = document.querySelectorALL('displayEmail');
    //             const phone = document.querySelectoALL('displayPhone');
    //             card.addEventListener("mouseover", () => {
    //                     name.style.display = "block";
    //                     phone.style.display = "block";
    //                     email.style.display = "block";
    ...
    //     })
        ...
        // const card = document.getElementsByClassName('card');
        //     const name = document.getElementsByClassName('displayName');
        //     const email = document.getElementsByClassName('displayEmail');
        //     const phone = document.getElementsByClassName('displayPhone');
        // card.addEventListener("mouseover", () => {
        //     name.style.display = "block";
        //     phone.style.display = "block";
        //     email.style.display = "block";
